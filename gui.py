...
im_b = Image.open('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\background.png')
...
im_w = Image.open('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\BB_RESET.png')
    ...
    if event == "Exit" or event == sg.WIN_CLOSED:
        ...
        if len(stations) == 1:
            try:
                ...
                fn = 'D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\DAYPLOTS\\DAYPLOT_DATE_20101216_STATION_%s_COMPONENT_%s_FILTER_%s_%s%s.PNG' %(stations[0],comp,filt,prep,zoom)
                ...
                img.save('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\temp.png','PNG')
                window["-IMAGE_L-"].update('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\temp.png')
                
                fn = 'D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\%s.PNG' %(stations[0])
                size = (int(w/3.5), int(h/3)-int(0.01*h))
                img_w = Image.open(fn).convert("RGBA")
                img_w = img_w.resize(size, resample=Image.BICUBIC)
                img_w.save('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\temp.png','PNG')
                window["-IMAGE_TR-"].update('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\temp.png')
            ...
            try:
                ...
                for ii in range(1,len(stations)):
                    ...
                    fn = 'D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\DAYPLOTS\\DAYPLOT_DATE_20101216_STATION_%s_COMPONENT_%s_FILTER_%s_%s%s.PNG' %(stations[ii],comp,filt,prep,zoom)
                ...
                cv2.imwrite('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\DAYPLOTS\\temp.png',new_img)
                new_img = Image.open('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\DAYPLOTS\\temp.png').convert("RGBA")
                size = (int(w/3+w/3)-int(0.01*w), int(0.67*h)-int(0.04*h))
                new_img = new_img.resize(size, resample=Image.BICUBIC)
                new_img.save('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\DAYPLOTS\\temp.png','PNG')
                ...
                window["-IMAGE_L-"].update('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\DAYPLOTS\\temp.png')
                if len(stations) < 5:
                ...
                size = (int(w/3.5), int(h/3))
                img_w = Image.open('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\BB_RESET.png')
                img_w = img_w.resize(size, resample=Image.BICUBIC)
                img_w.save('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\temp.png','PNG')
                window["-IMAGE_TR-"].update('D:\\Seagate Dashboard\\UTAS 2019-2021\\1_Masters_2020\\Winberry station plots\\ALL_BB_STATIONS\\DAYPLOT_REPOSITORY\\images\\temp.png')
            except:
